...
public class MenuManager implements ActionListener {
	...
	private LifeApp application = null;
	 ...
	 */
	public MenuManager(LifeApp application) {
	 ...
	 */
	public MenuManager(LifeApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(LifeApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		private LifeApp application;

		protected ExitAction(LifeApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(LifeApp application) {
			super("AboutAction");
			this.application = application;
		}
